...
function getRequiredParams(target, event, targetBorder) {
  ...
  return { width, height, dx, dy, style, radius, border }
}
...
function createRippleContainer() {
  ...
  return { ripple, rippleContainer }
}

function addRippleStyles(ripple, props, zIndex, bg, rippleContainer, border) {
...
const Ripple = {
  bind(el, binding) {
    ...
    function rippler(event, el) {
      ...
      addRippleStyles(ripple, props, zIndex, bg, rippleContainer, border)
